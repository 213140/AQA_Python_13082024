...
logger = logging.getLogger(__name__ + 'lesson_17_debugging')
...
def get_address():
	...
	for i in range(6,9): # changed from range (6,12)
		...
		for addr in addrFile:
			try:
				...
				pass
		# Logging data for debug purpose - finding exercise bug - A. Mackevic
		# logger.debug(f"""LOGGING point:"
		# i = {i} and addr[i] = {addr[i]}
		# allAddrs len is {allAddrs.__len__()}""")
