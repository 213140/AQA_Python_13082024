...
#year >= , engine_volume >= , price <=, by price ascending, chipest 5 cars
...
list_of_passing_cars.sort()
list_of_top_five = list_of_passing_cars[:5]

for best_car in list_of_top_five:
  print(f"""No {list_of_top_five.index(best_car) + 1} 
  {best_car[1]} with price {best_car[0]}""")